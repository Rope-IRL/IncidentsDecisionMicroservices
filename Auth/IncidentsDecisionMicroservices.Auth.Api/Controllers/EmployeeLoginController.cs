...
namespace IncidentsDecisionMicroservices.Auth.Api.Controllers;

[ApiController]
[Authorize(Roles ="Employee")]
[Route("/api/[controller]/")]
public class EmployeeLoginController(IEmployeeLoginService service, IConfiguration configuration)
    : ControllerBase
{
    [HttpGet]
    public async Task<ActionResult<IEnumerable<EmployeeLoginDto>>> GetEmployeeLogins(
    ...
    [HttpGet("{id:int}")]
    public async Task<ActionResult<EmployeeLoginDto>> GetEmployeeLoginById(int id, 
        CancellationToken cancellationToken)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<EmployeeLoginDto>> UpdateEmployeeLogin(
        [FromBody] EmployeeLoginUpdateDto dto,
        CancellationToken cancellationToken)
    {
    ...
    [AllowAnonymous]
    [HttpPut]
    public async Task<ActionResult<EmployeeLoginDto>> CreateEmployeeLogin(
        [FromBody] EmployeeLoginCreateDto dto,
        CancellationToken cancellationToken)
    {
    ...
    [AllowAnonymous]
    [HttpPost("login")]
    public async Task<ActionResult<string>> LoginEmployee([FromBody] EmployeeLoginCreateDto dto,
        CancellationToken cancellationToken)
    {
        ...
        HttpContext.Response.Cookies.Append(configuration["JWT:Name"], tokenResult.Value, 
            new CookieOptions
        {
